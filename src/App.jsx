  ...
  return (
    <MenuDrawer open={open} onClose={closeMenu}>
      ...
      <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
        <li style={{ marginBottom: 24 }}><a href="/" className="text-xl text-[#222] no-underline">Home</a></li>
        <li style={{ marginBottom: 24 }}><a href="/sunaba" className="text-xl text-[#222] no-underline">Sunaba</a></li>
        {/* 必要に応じて追加 */}
      </ul>
    </MenuDrawer>
  );
