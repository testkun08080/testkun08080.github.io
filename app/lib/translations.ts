...
export const messages = {
  ja: {
    ...
    nav_language: "言語",
    hero_title: "ようこそ",
    hero_subtitle: "技術とアートをつなぐポートフォリオ",
    hero_cta_primary: "作品を見る",
    hero_cta_secondary: "アバウトへ",
    hero_description:
      "Vike + React へ移行した新しいサイトです。滑らかなアニメーションとレスポンシブレイアウトで構築しています。",
    sunaba_jp: "すなば",
    sunaba_en: "SUNABA",
    sunaba_message: "実験と表現のためのサンドボックス",
    about_title: "アバウト",
    about_greeting:
      "はじめまして。長谷川翔一です。テクノロジーを使って、表現の可能性を広げることに情熱を持っています。",
    about_resume: "履歴書",
    ...
    contact_title: "コンタクト",
    contact_info: "testkun.08080@gmail.com",
  ...
  en: {
    ...
    hero_title: "Welcome",
    hero_subtitle: "A portfolio connecting technology and art",
    hero_cta_primary: "View Works",
    hero_cta_secondary: "About",
    hero_description:
      "This site has been migrated to Vike + React, with smooth motion and a responsive layout.",
    sunaba_jp: "SUNABA",
    sunaba_en: "Sandbox",
    sunaba_message: "A sandbox for experiments and expression",
    about_title: "About",
    about_greeting:
      "Nice to meet you. I'm Shoichi Hasegawa, passionate about expanding creative expression through technology.",
    about_resume: "Resume",
